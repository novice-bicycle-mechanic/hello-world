...
int main() {
	...
	// Создадим объекты test 1, test 2, test 3 - для результата
	Test test1(1, 3);
	Test test2(1, 2);
	Test test3;

	// Покажем созданные test1 и test2
	std::cout << " Создадим дроби:" << std::endl;
	showCreatedFraction(test1, test2);
	std::cout << std::endl;

	// Сложим дроби
	std::cout << " Сложим дроби:" << std::endl;
	test3 = test1 + test2;
	showFraction('+', test1, test2, test3);
	std::cout << std::endl;
